...
def mostra_uso_memoria():
    ...
    pygame.draw.rect(superficie_grafico_memoria, Dim, (20, 50, larg/2, 70))
    ...
    superficie_grafico_memoria.blit(texto, (20, 10))
    tela.blit(superficie_grafico_memoria, (20, 250))
...
lista_envolucro = ['CPU', 'MEM', 'DISC', 'NET']
posicao_atual = 0
...
while not terminou:
    ...
    if count == 60:
        ...
        if posicao_atual < posicao_cpu:
            posicao_atual = posicao_cpu
            
        elif posicao_atual > posicao_res:
            posicao_atual = posicao_res
