...
def getIp():
  ...
  if plataforma == 'Linux':
    ...
    ip = (dic_interfaces['wlan0'][0].address)
    return ""
  else:
    ip = (dic_interfaces['wlp3s0'][0].address)
    return ""
...
def mostra_uso_cpu():
  ...
  pygame.draw.rect(superficie_cpu, azul, (20, 50, larg, 70))
  larg = larg * capacidade/100

  pygame.draw.rect(superficie_cpu, Dim, (20, 50, larg, 70))
  cpu = psutil.cpu_percent()

  frase = "Uso de CPU: " + str(cpu)
...
def mostra_uso_memoria():
  ...
  pygame.draw.rect(superficie_memoria, azul, (20, 50, larg, 70))
  larg = larg * mem.percent/100
  
  pygame.draw.rect(superficie_memoria, Dim, (20, 50, larg, 70))
